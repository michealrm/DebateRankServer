...
public class PFRound {
	...
	public PFRound(Team aff, Team neg, boolean bye, String absUrl, String round, boolean noSide) {
	...
	public PFRound(Team aff, Team neg, boolean bye, String absUrl, String round, List<Ballot> ballot, boolean noSide) {
